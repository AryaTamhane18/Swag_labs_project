...
class Parser:
        ...
        while items:
            ...
            if item.is_complete:   ### (item.s == string)
                ...
                ###R Regular Earley completer
                    ...
                    # parse steps, we need to be able to use that same empty symbol to complete
    ...
    def _parse(self, lexer, columns, to_scan, start_symbol=None):
        ...
        # Cache for nodes & tokens created in a particular parse steps.
        transitives = [{}]
    ...
    def parse(self, lexer, start):
        ...
        # symbol should have been completed in the last steps of the Earley cycle, and will be in
