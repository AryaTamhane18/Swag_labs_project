...
transform/scrolling purposes only.
    ...
    /**
     * Array of timings, one per paint steps.
     */
    ...
    export type replaySnapshotParameters = {
      ...
      snapshotId: SnapshotId;
      /**
       * The first steps to replay from (replay from the very start if not specified).
       */
      fromStep?: number;
      /**
       * The last steps to replay to (replay till the end if not specified).
       */
      toStep?: number;
      /**
...
== false`.
    ...
    export type setPausedInDebuggerMessageParameters = {
      /**
       * The message to display, also triggers resume and steps over controls.
       */
      message?: string;
    }
...
(steps 4 of https://fedidcg.github.io/FedCM/#browser-api-rp-sign-in)
       */
...
performing 'steps in' several times, finally resorting to 'steps out' if unsuccessful.
     */
...
scripts by performing 'steps in' several times, finally resorting to 'steps out' if unsuccessful.
...
before next pause.
      ...
      /**
       * The skipList specifies location ranges that should be skipped on steps into.
       */
    ...
    export type stepOverParameters = {
      /**
       * The skipList specifies location ranges that should be skipped on steps over.
       */
      skipList?: LocationRange[];
    }
