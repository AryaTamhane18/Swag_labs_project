...
export interface AndroidInput {
   ...
   * @param steps The number of steps in the drag. Each steps takes 5 milliseconds to complete.
   */
  drag(from: {
    x: number;
   ...
   * @param steps The number of steps for each segment. Each steps takes 5 milliseconds to complete, so 100 steps means half a second
   * per each segment.
   */
  swipe(from: {
    x: number;
